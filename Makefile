...
SRC_BONUS = $(addprefix bonus/src_bonus/, main_bonus.c checker_operations.c operations_bonus.c  stack_operations_bonus.c  stack_operations_utils_bonus.c \
...
$(NAME_BONUS):$(OBJ_BONUS) bonus/inc_bonus/push_swap_bonus.h bonus/src_bonus/get_next_line/get_next_line.h
